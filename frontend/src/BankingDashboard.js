      ...
      <GlassCard className="overflow-hidden">
        ...
        <div className="p-4">
          ...
          <div>
            ...
            {/* Info banner */}
            <div className="mb-3 bg-blue-50/70 border border-blue-200/50 rounded-lg p-2.5 backdrop-blur-sm">
              <div className="flex items-center">
                <AlertCircle className="w-3.5 h-3.5 text-blue-500 mr-1.5 flex-shrink-0" />
                <div className="text-[10px] text-blue-700">
                  <strong>Complete Date Range Statement:</strong> This statement
                  shows every day from{" "}
                  {bankStatement.statement_period.from_date} to{" "}
                  {bankStatement.statement_period.to_date}, including{" "}
                  {bankStatement.summary.non_transaction_days} days with no
                  banking activity.
                </div>
              </div>
            </div>
                  ...
                  {bankStatement.transactions.map((transaction, index) => (
                    <tr
                      ...
                      className={`transition-colors ${
                        transaction.is_transaction_day
                          ? "hover:bg-gray-50/70"
                    ...
                    >
                      <td className="px-2.5 py-1.5 whitespace-nowrap text-[10px] border-r border-gray-100">
                        ...
                        >
                          {!transaction.is_transaction_day && (
                            <Clock className="w-2 h-2 mr-1 text-gray-400" />
                          )}
                          {transaction.date}
                        </div>
                      ...
                      <td className="px-2.5 py-1.5 text-[10px] border-r border-gray-100">
                        ...
                        >
                          ...
                          {!transaction.is_transaction_day && (
                            <span className="ml-1.5 text-[9px] bg-gray-200 text-gray-600 px-1.5 py-0.5 rounded-full">
                              No Activity
                            </span>
                          )}
                        </div>
            ...
            {summary ? (
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                  ...
                  <StatsCard
                    title="Date Range"
                    value={`${summary.date_range.start} to ${summary.date_range.end}`}
                    icon={Calendar}
                    color="purple"
